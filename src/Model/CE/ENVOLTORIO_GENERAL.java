...
public class ENVOLTORIO_GENERAL {
    ...
    public ENVOLTORIO_GENERAL() {
        this.lista_ventas = new EnvoltoriaVentas();
        this.lista_productos = new EnvoltoriaProductos();
        this.lista_clientes = new EnvoltoriaClientes();
    }
